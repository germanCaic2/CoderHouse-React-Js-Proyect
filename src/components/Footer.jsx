  ...
  return (
    <footer id="Footer" className="bg-secondary p-3 d-flex justify-content-around mt-auto">
      ...
      <div className="bg-light rounded">
        <a href="https://github.com/germanCaiced6" className="p-2">GitHub <img src="../images/github.svg" alt="Github"/></a>
        <a href="https://github.com/germanCaiced6" className="p-2">LinkedIn <img src="../images/linkedin.svg" alt="LinkedIn"/></a>
      </div>
    </footer>
  );
}
